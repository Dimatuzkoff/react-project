//react
import {type FC, useState, useRef, type ReactNode, type Dispatch, type SetStateAction} from "react";
//hooks
...
export const Select: FC<SelectProps> = ({
    ...
    const handleKeyDown = (e: React.KeyboardEvent) => {
        if (e.key === "Backspace" && !searchText && !isMultiSelect && selected.length > 0) {
            setSelected([]);
        }
    };
